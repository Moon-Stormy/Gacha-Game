const cards = [
    ...
    { name: "Hannarabe", file: "anna.png", rarity: "common" },
    ...
    { name: "Ambreeee coucouuuu", file: "ambre.png", rarity: "common" },
    ...
    { name: "Le self (lieu convivial)", file: "self.png", rarity: "rare" },
    ...
    { name: "L'appel Discord", file: "discord.png", rarity: "epic" },

    // Legendary
    { name: "Le Royaume de Nelle", file: "lesenfersdenelle.png", rarity: "legendary" },
    { name: "Tom le Goat du hand", file: "tomhandball.png", rarity: "legendary" }
];
